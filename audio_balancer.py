...
class AudioBalancerApp(ctk.CTk, *([TkinterDnD.DnDWrapper] if _DND_AVAILABLE else [])):
    ...
    def create_layout(self):
        ...
        self.info_frame.grid(row=4, column=0, padx=20, pady=(5, 15), sticky="ew")
        ...
        self.format_menu = ctk.CTkOptionMenu(self.card_fmt, values=["Original", "WAV", "MP3"], fg_color="#3A3A3C", height=24, width=86, font=("Arial", 11), anchor="center")
        ...
        self.sr_menu = ctk.CTkOptionMenu(self.card_sr, values=["Original", "44100", "48000", "96000"], fg_color="#3A3A3C", height=24, width=86, font=("Arial", 11), anchor="center")
        ...
        ctk.CTkLabel(self.card_bit, text="音質:", font=("Arial", 11), text_color="#8E8E93").pack(side="left", padx=(10, 5), pady=8)
        self.bit_menu = ctk.CTkOptionMenu(self.card_bit, values=["Original", "16-bit", "24-bit", "320k"], fg_color="#3A3A3C", height=24, width=86, font=("Arial", 11), anchor="center")
    ...
    def start_export_thread(self):
        ...
        threading.Thread(target=self.export_process, args=(fmt, selected_workspaces), daemon=True).start()

    def export_process(self, fmt, workspaces):
